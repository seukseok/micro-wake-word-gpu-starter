...
When changing README content, update both [README.md](README.md) and [README.en.md](README.en.md) in the same commit so the Korean and English docs stay aligned.
